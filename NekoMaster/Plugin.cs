...
namespace NekoMaster
{
    public sealed class Plugin : IDalamudPlugin
    {
            ...
            [RequiredVersion("1.0")] CommandManager commandManager)
        {
            ...
            this.cmd.AddHandler("/loadall", new CommandInfo(OnCommand) { HelpMessage =   "load all plugin" });
            this.cmd.AddHandler("/unloadall", new CommandInfo(OnCommand) { HelpMessage = "unload all plugin" });
            this.cmd.AddHandler("/reloadall", new CommandInfo(OnCommand) { HelpMessage = "reload all plugin" });
